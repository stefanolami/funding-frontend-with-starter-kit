...
export class MobileHeader extends TailwindElement(style) {
    ...
    render() {
        return html`
        <div @click=${this.clickInside} class="mobile flex md:hidden justify-between items-center select-none md:bg-transparent pt-2 pb-2 md:pt-4 md:pb-4 xl:pt-7 xl:pb-7">
            <object class="w-[138px] h-[43px] ml-4" data="../images/T&Pfunding-logo.svg" ></object>
            <div  id="mobile-menu-div" class="md:hidden relative mr-3">
                <div @click=${this.openCloseMenu} id="mobile-menu" class="select-none md:hidden">
                ...
                <nav id="mobile-menu-nav" class="${this.isShowing? 'flex':'hidden'} mobile absolute z-20 w-[148px] md:w-[500px] h-[352px] md:h-full top-[-4px] right-0 flex-col justify-between border-primary border-[3px] rounded-lg rounded-tr-none md:border-none bg-white md:bg-transparent">    
                    <div @click=${this.closeMenu} id="mobile-menu-close" class="ml-[85%] mt-0 font-nunito-400  text-primary text-lg md:hidden">x</div>
