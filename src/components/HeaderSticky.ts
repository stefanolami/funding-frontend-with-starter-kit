...
@customElement("my-header-sticky")
export class HeaderSticky extends TailwindElement(style) {
    ...
    render() {
        ...
        <header>
            ...
            <div class="hidden ${classMap({'md:hidden': this.withImg == true, 'md:flex': this.withImg == false})} justify-between items-center select-none md:bg-transparent pb-2 md:pt-2 md:pb-4 xl:pt-3 xl:pb-7">
                ...
                <nav id="header-nav" class="fixed top-2 left-96 bg-white h-20 flex flex-row justify-around xl:justify-center items-center w-[70%] font-jose-400-it text-base text-center">    
            ...
            <div id="header-with-hands" class="relative hidden ${classMap({'md:hidden': this.withImg == false, 'md:flex': this.withImg == true})} flex-col justify-between ">
                ...
                <div class="fixed w-full flex justify-between items-center select-none bg-transparent xl:mt-4">
                    <a class="xl:hidden ml-7" href="./home.html">
