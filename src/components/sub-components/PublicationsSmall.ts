    ...
    render() {
        return html`
            <div class="">
                ...
                <div class="flex xl:hidden justify-center items-center w-28 h-9 md:w-40 md:h-11 m-auto mt-12 mb-28 pt-[2px] border-2 border-primary-dark2 rounded-full font-jose-600 text-primary-dark2 text-xs md:text-base xl:text-base cursor-pointer hover:bg-primary hover:text-white hover:border-primary">LOAD MORE</div>        
            </div>     
        `;
    }
