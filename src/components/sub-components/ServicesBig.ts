            ...
            <div class="hidden md:block mt-14">
                ...
                <div class="relative w-[770px] xl:w-[1050px] mx-auto mt-40 mb-60 select-none">
                    ...
                    <div class="hidden absolute tablet-services-div tablet-project-initiation top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
                        ...
                        <a  href="./contact.html" class="hidden xl:flex mx-auto mt-9 w-[181px] h-12  justify-center items-center pt-[2px] font-jose-600 text-[16px] leading-[21px] text-mygreen border-mygreen border-[3px] rounded-full">
                    ...
                    <div class="hidden absolute tablet-services-div tablet-project-planning top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
                        ...
                        <a  href="./contact.html" class="hidden xl:flex mx-auto mt-9 w-[181px] h-12  justify-center items-center pt-[2px] font-jose-600 text-[16px] leading-[21px] text-primary border-primary border-[3px] rounded-full">
                            <div>GET IN TOUCH</div>
                        </a>
                    </div>
                    <div class="hidden absolute tablet-services-div tablet-project-planning top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
                    ...
                    <div class="hidden absolute tablet-services-div tablet-project-execution top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
                        ...
                        <a  href="./contact.html" class="hidden xl:flex mx-auto mt-9 w-[181px] h-12  justify-center items-center pt-[2px] font-jose-600 text-[16px] leading-[21px] text-primary-dark2 border-primary-dark2 border-[3px] rounded-full">
                            <div>GET IN TOUCH</div>
                        </a>
                    </div>
                    <div class="hidden absolute tablet-services-div tablet-project-execution top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
                    ...
                    <div class="hidden absolute tablet-services-div tablet-project-closure top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
                        ...
                        <a  href="./contact.html" class="hidden xl:flex mx-auto mt-9 w-[181px] h-12  justify-center items-center pt-[2px] font-jose-600 text-[16px] leading-[21px] text-mygrey border-mygrey border-[3px] rounded-full">
                            <div>GET IN TOUCH</div>
                        </a>
                    </div>
                    <div class="hidden absolute tablet-services-div tablet-project-closure top-44 xl:top-[200px] left-[210px] xl:left-[330px] z-20 w-[402px] h-[340px]">
