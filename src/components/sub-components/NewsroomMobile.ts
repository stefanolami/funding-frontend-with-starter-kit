                ...
                <div class="flex flex-col mx-5 mt-4">
                    <div class="flex justify-center items-center relative h-[200px] my-[6px] bg-primary">   <!-- DEFAULT NEWS BLOCK -->
                        ...
                        <div class="absolute top-0 right-0 p-2 leading-4">
                            <p class="font-unna-700 text-[13.5px] text-white text-right">Sebastian Lenders</p>
                        ...
                        <a href="" class="absolute bottom-2 right-2 w-[87px] h-8 flex justify-center items-center pt-[2px] border-2 border-white rounded-full font-jose-600 text-white text-[10px] leading-3 hover:text-primary-dark2 hover:bg-white hover:border-white cursor-pointer">READ MORE</a>
                    </div>
                    ...
                    <div class="flex justify-center items-center relative h-[200px] my-[6px] border border-primary text-primary-dark2">   <!-- WHITE NEWS BLOCK -->
                        ...
                        <div class="absolute top-0 right-0 p-2 leading-4">
                            <p class="font-unna-700 text-[13.5px] text-right">Press Release</p>
                        ...
                        <a href="" class="absolute bottom-2 right-2 w-[87px] h-8 flex justify-center items-center pt-[2px] border-2 border-primary rounded-full font-jose-600 text-[10px] leading-3 hover:text-white hover:bg-primary hover:border-primary cursor-pointer">READ MORE</a>
                    </div>
                </div>
